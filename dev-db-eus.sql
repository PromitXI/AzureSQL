/****** Object:  Database [dev-db-eus]    Script Date: 14-03-2023 18:35:07 ******/
CREATE DATABASE [dev-db-eus]  (EDITION = 'GeneralPurpose', SERVICE_OBJECTIVE = 'GP_S_Gen5_1', MAXSIZE = 2 GB) WITH CATALOG_COLLATION = SQL_Latin1_General_CP1_CI_AS, LEDGER = OFF;
GO
ALTER DATABASE [dev-db-eus] SET COMPATIBILITY_LEVEL = 150
GO
ALTER DATABASE [dev-db-eus] SET ANSI_NULL_DEFAULT OFF 
GO
ALTER DATABASE [dev-db-eus] SET ANSI_NULLS OFF 
GO
ALTER DATABASE [dev-db-eus] SET ANSI_PADDING OFF 
GO
ALTER DATABASE [dev-db-eus] SET ANSI_WARNINGS OFF 
GO
ALTER DATABASE [dev-db-eus] SET ARITHABORT OFF 
GO
ALTER DATABASE [dev-db-eus] SET AUTO_SHRINK OFF 
GO
ALTER DATABASE [dev-db-eus] SET AUTO_UPDATE_STATISTICS ON 
GO
ALTER DATABASE [dev-db-eus] SET CURSOR_CLOSE_ON_COMMIT OFF 
GO
ALTER DATABASE [dev-db-eus] SET CONCAT_NULL_YIELDS_NULL OFF 
GO
ALTER DATABASE [dev-db-eus] SET NUMERIC_ROUNDABORT OFF 
GO
ALTER DATABASE [dev-db-eus] SET QUOTED_IDENTIFIER OFF 
GO
ALTER DATABASE [dev-db-eus] SET RECURSIVE_TRIGGERS OFF 
GO
ALTER DATABASE [dev-db-eus] SET AUTO_UPDATE_STATISTICS_ASYNC OFF 
GO
ALTER DATABASE [dev-db-eus] SET ALLOW_SNAPSHOT_ISOLATION ON 
GO
ALTER DATABASE [dev-db-eus] SET PARAMETERIZATION SIMPLE 
GO
ALTER DATABASE [dev-db-eus] SET READ_COMMITTED_SNAPSHOT ON 
GO
ALTER DATABASE [dev-db-eus] SET  MULTI_USER 
GO
ALTER DATABASE [dev-db-eus] SET ENCRYPTION ON
GO
ALTER DATABASE [dev-db-eus] SET QUERY_STORE = ON
GO
ALTER DATABASE [dev-db-eus] SET QUERY_STORE (OPERATION_MODE = READ_WRITE, CLEANUP_POLICY = (STALE_QUERY_THRESHOLD_DAYS = 30), DATA_FLUSH_INTERVAL_SECONDS = 900, INTERVAL_LENGTH_MINUTES = 60, MAX_STORAGE_SIZE_MB = 100, QUERY_CAPTURE_MODE = AUTO, SIZE_BASED_CLEANUP_MODE = AUTO, MAX_PLANS_PER_QUERY = 200, WAIT_STATS_CAPTURE_MODE = ON)
GO
/*** The scripts of database scoped configurations in Azure should be executed inside the target database connection. ***/
GO
-- ALTER DATABASE SCOPED CONFIGURATION SET MAXDOP = 8;
GO
/****** Object:  Schema [SalesLT]    Script Date: 14-03-2023 18:35:07 ******/
CREATE SCHEMA [SalesLT]
GO
/****** Object:  UserDefinedDataType [dbo].[AccountNumber]    Script Date: 14-03-2023 18:35:07 ******/
CREATE TYPE [dbo].[AccountNumber] FROM [nvarchar](15) NULL
GO
/****** Object:  UserDefinedDataType [dbo].[Flag]    Script Date: 14-03-2023 18:35:07 ******/
CREATE TYPE [dbo].[Flag] FROM [bit] NOT NULL
GO
/****** Object:  UserDefinedDataType [dbo].[Name]    Script Date: 14-03-2023 18:35:07 ******/
CREATE TYPE [dbo].[Name] FROM [nvarchar](50) NULL
GO
/****** Object:  UserDefinedDataType [dbo].[NameStyle]    Script Date: 14-03-2023 18:35:07 ******/
CREATE TYPE [dbo].[NameStyle] FROM [bit] NOT NULL
GO
/****** Object:  UserDefinedDataType [dbo].[OrderNumber]    Script Date: 14-03-2023 18:35:07 ******/
CREATE TYPE [dbo].[OrderNumber] FROM [nvarchar](25) NULL
GO
/****** Object:  UserDefinedDataType [dbo].[Phone]    Script Date: 14-03-2023 18:35:07 ******/
CREATE TYPE [dbo].[Phone] FROM [nvarchar](25) NULL
GO
/****** Object:  Sequence [SalesLT].[SalesOrderNumber]    Script Date: 14-03-2023 18:35:08 ******/
CREATE SEQUENCE [SalesLT].[SalesOrderNumber] 
 ...
 CACHE 
GO
/****** Object:  UserDefinedFunction [dbo].[ufnGetAllCategories]    Script Date: 14-03-2023 18:35:08 ******/
SET ANSI_NULLS ON
GO
...
END;
GO
/****** Object:  UserDefinedFunction [dbo].[ufnGetSalesOrderStatusText]    Script Date: 14-03-2023 18:35:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  Table [SalesLT].[Customer]    Script Date: 14-03-2023 18:35:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  UserDefinedFunction [dbo].[ufnGetCustomerInformation]    Script Date: 14-03-2023 18:35:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [SalesLT].[ProductModel]    Script Date: 14-03-2023 18:35:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [SalesLT].[vProductModelCatalogDescription]    Script Date: 14-03-2023 18:35:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [SalesLT].[ProductDescription]    Script Date: 14-03-2023 18:35:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [SalesLT].[Product]    Script Date: 14-03-2023 18:35:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [SalesLT].[ProductModelProductDescription]    Script Date: 14-03-2023 18:35:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [SalesLT].[vProductAndDescription]    Script Date: 14-03-2023 18:35:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Index [IX_vProductAndDescription]    Script Date: 14-03-2023 18:35:08 ******/
...
GO
/****** Object:  Table [SalesLT].[ProductCategory]    Script Date: 14-03-2023 18:35:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  View [SalesLT].[vGetAllCategories]    Script Date: 14-03-2023 18:35:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
ON PC.[ProductCategoryID] = CCTE.[ParentProductCategoryID]
GO
/****** Object:  Table [dbo].[BuildVersion]    Script Date: 14-03-2023 18:35:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [dbo].[ErrorLog]    Script Date: 14-03-2023 18:35:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [SalesLT].[Address]    Script Date: 14-03-2023 18:35:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [SalesLT].[CustomerAddress]    Script Date: 14-03-2023 18:35:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [SalesLT].[SalesOrderDetail]    Script Date: 14-03-2023 18:35:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
GO
/****** Object:  Table [SalesLT].[SalesOrderHeader]    Script Date: 14-03-2023 18:35:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [IX_Address_AddressLine1_AddressLine2_City_StateProvince_PostalCode_CountryRegion]    Script Date: 14-03-2023 18:35:08 ******/
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [IX_Address_StateProvince]    Script Date: 14-03-2023 18:35:08 ******/
...
SET ANSI_PADDING ON
GO
/****** Object:  Index [IX_Customer_EmailAddress]    Script Date: 14-03-2023 18:35:08 ******/
CREATE NONCLUSTERED INDEX [IX_Customer_EmailAddress] ON [SalesLT].[Customer]
(
	[EmailAddress] ASC
)WITH (STATISTICS_NORECOMPUTE = OFF, DROP_EXISTING = OFF, ONLINE = OFF, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
GO
/****** Object:  Index [IX_SalesOrderDetail_ProductID]    Script Date: 14-03-2023 18:35:08 ******/
CREATE NONCLUSTERED INDEX [IX_SalesOrderDetail_ProductID] ON [SalesLT].[SalesOrderDetail]
(
	[ProductID] ASC
)WITH (STATISTICS_NORECOMPUTE = OFF, DROP_EXISTING = OFF, ONLINE = OFF, OPTIMIZE_FOR_SEQUENTIAL_KEY = OFF) ON [PRIMARY]
GO
/****** Object:  Index [IX_SalesOrderHeader_CustomerID]    Script Date: 14-03-2023 18:35:08 ******/
...
GO
/****** Object:  StoredProcedure [dbo].[uspLogError]    Script Date: 14-03-2023 18:35:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
/****** Object:  StoredProcedure [dbo].[uspPrintError]    Script Date: 14-03-2023 18:35:08 ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
END;
GO
ALTER DATABASE [dev-db-eus] SET  READ_WRITE 
GO
